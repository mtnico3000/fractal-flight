# Fractal Alps — Mandelbrot Flight v9.6
...
- **`fractal-flight-v9_6.html`** — double-click it. One self-contained file,
...
fractal-flight-v9_6.html   GENERATED by build.js -- the double-click build. Never edit.
js/

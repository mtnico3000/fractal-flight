# Fractal Alps — Mandelbrot Flight v9.4
...
- **`fractal-flight-v9_4.html`** — double-click it. One self-contained file,
...
fractal-flight-v9_4.html   GENERATED by build.js -- the double-click build. Never edit.
js/

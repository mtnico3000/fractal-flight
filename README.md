# Fractal Alps — Mandelbrot Flight v9.8
...
- **`fractal-flight-v9_8.html`** — double-click it. One self-contained file,
...
fractal-flight-v9_8.html   GENERATED by build.js -- the double-click build. Never edit.
js/

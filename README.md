# Fractal Alps — Mandelbrot Flight v9.7
...
- **`fractal-flight-v9_7.html`** — double-click it. One self-contained file,
...
fractal-flight-v9_7.html   GENERATED by build.js -- the double-click build. Never edit.
js/

# Fractal Alps — Mandelbrot Flight v9.2
...
- **`fractal-flight-v9_2.html`** — double-click it. One self-contained file,
...
fractal-flight-v9_2.html   GENERATED by build.js -- the double-click build. Never edit.
js/

...
export function hullExplosionSound() {
  ...
  // The four layers sum to ~1.76 at unity, so ANY gain above ~1.2 would clip
  // on the destination and turn a soft boom into a crunch -- which is exactly
  // the character being protected. They go through a limiter instead: it only

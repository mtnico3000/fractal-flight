...
export async function initRenderer(status, lock) {
  ...
  ['uResolution','uTime','uCamPos','uCamMat','uSunDir','uFov','uJitter','uPixScale','uDetailFade','uRayTol','uHitRefine','uMarchStride','uTreePersp','uWaterLOD','uBoxRound','uDebugMask','uCraftPos','uCraftMat','uBulletPos','uBombPos','uBlastCell','uCloudPos','uCloudN',
